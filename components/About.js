        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div ref={textRef} className="space-y-6">
            ...
            <p className="text-gray-300">
              Desarrollador Full Stack con sólida experiencia en el stack MERN y especialización en Automatización de Procesos con IA.
              Experto en la orquestación de flujos complejos utilizando n8n, integración de LLMs (OpenAI, Anthropic, Gemini, DeepSeek)
              y gestión avanzada de bases de datos.
            </p>
            <p className="text-gray-300">
              Fundador de una agencia de automatización con casos de éxito en producción, gestionando altos volúmenes de conversaciones automatizadas.
              Combino visión de negocio con arquitectura de software para crear soluciones escalables.
            </p>
